...
- Simplifies to a vector or matrix if possible, otherwise returns list as usual
...
- Vectorize arguments to a function that doesn't usually accept vectors as arguments
